...
func TestChannels(t *testing.T) {
	...
	checker.Mount(server.NewListHandler, server.MountListHandler, epWrapper(channels.NewListEndpoint(srvc, apiKeyAuth)))
	checker.Mount(server.NewShowHandler, server.MountShowHandler, epWrapper(channels.NewShowEndpoint(srvc, apiKeyAuth)))
	checker.Mount(server.NewCreateHandler, server.MountCreateHandler, epWrapper(channels.NewCreateEndpoint(srvc, apiKeyAuth)))
	checker.Mount(server.NewUpdateHandler, server.MountUpdateHandler, epWrapper(channels.NewUpdateEndpoint(srvc, apiKeyAuth)))
	checker.Mount(server.NewDeleteHandler, server.MountDeleteHandler, epWrapper(channels.NewDeleteEndpoint(srvc, apiKeyAuth)))
