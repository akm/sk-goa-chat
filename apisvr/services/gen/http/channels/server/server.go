...
// Server lists the channels service endpoint HTTP handlers.
type Server struct {
	Mounts []*MountPoint
	List   http.Handler
	Show   http.Handler
...
// New instantiates HTTP handlers for all the channels service endpoints using
...
func (s *Server) Service() string { return "channels" }
...
func (s *Server) MethodNames() []string { return channels.MethodNames[:] }

// Mount configures the mux to serve the channels endpoints.
...
// MountListHandler configures the mux to serve the "channels" service "list"
// endpoint.
func MountListHandler(mux goahttp.Muxer, h http.Handler) {
	...
	mux.Handle("GET", "/api/channels", f)
}

// NewListHandler creates a HTTP handler which loads the HTTP request and calls
// the "channels" service "list" endpoint.
func NewListHandler(
...
// MountShowHandler configures the mux to serve the "channels" service "show"
// endpoint.
...
// MountCreateHandler configures the mux to serve the "channels" service
// "create" endpoint.
func MountCreateHandler(mux goahttp.Muxer, h http.Handler) {
	...
	mux.Handle("POST", "/api/channels", f)
}

// NewCreateHandler creates a HTTP handler which loads the HTTP request and
// calls the "channels" service "create" endpoint.
...
// MountUpdateHandler configures the mux to serve the "channels" service
// "update" endpoint.
func MountUpdateHandler(mux goahttp.Muxer, h http.Handler) {
	...
	mux.Handle("PUT", "/api/channels/{id}", f)
}

// NewUpdateHandler creates a HTTP handler which loads the HTTP request and
// calls the "channels" service "update" endpoint.
...
// MountDeleteHandler configures the mux to serve the "channels" service
// "delete" endpoint.
func MountDeleteHandler(mux goahttp.Muxer, h http.Handler) {
	...
	mux.Handle("DELETE", "/api/channels/{id}", f)
}

// NewDeleteHandler creates a HTTP handler which loads the HTTP request and
// calls the "channels" service "delete" endpoint.
